...
declare module "nitropack/types" {
  ...
  interface InternalApi {
    '/api/auth/:action': {
      'default': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server<dyad-write path=".nitro/types/nitro-routes.d.ts" description="Atualizando rotas do nitro para incluir novos endpoints">
// Generated by nitro
import type { Serialize, Simplify } from "nitropack/types";
declare module "nitropack/types" {
  type Awaited<T> = T extends PromiseLike<infer U> ? Awaited<U> : T
